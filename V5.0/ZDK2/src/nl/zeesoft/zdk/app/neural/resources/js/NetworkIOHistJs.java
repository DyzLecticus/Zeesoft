...
public class NetworkIOHistJs extends Resource {
	...
	protected void render(StringBuilder r) {
		...
		append(r, "networkIOHist.accuracyRange = 1.0;");
	...
	protected void renderProcessedNetworkIO(StringBuilder r) {
		...
		append(r, "    networkIOHist.appendHtmlTableRow(networkIo);");
		append(r, "};");
	}
	...
	protected void renderToHtmlTable(StringBuilder r) {
		...
		append(r, "    html += \"<tr>\";");
		append(r, "    html += \"<th>DateTime</th>\";");
		append(r, "    html += \"<th>Value</th>\";");
		append(r, "    html += \"<th>Predicted</th>\";");
		append(r, "    html += \"<th colspan='\" + networkIOHist.graphWidth + \"'>Graph</th>\";");
		append(r, "    html += \"</tr>\";");
		append(r, "    for (var i = 0; i < networkIOHist.io.length; i++) {");
