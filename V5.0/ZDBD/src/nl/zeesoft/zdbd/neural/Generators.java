...
public class Generators {
	...
	public void initializeDefaults(boolean maintainNote, float mixEnd) {
		...
		gen.group1Distortion = 0.1F;
		gen.group2Distortion = 0.1F;
		gen.group3Distortion = 0.1F;
		gen.mixEnd = mixEnd;
		if (!maintainNote) {
		...
		gen.group1Distortion = 0.1F;
		gen.group2Distortion = 0.0F;
		gen.group3Distortion = 0.0F;
		gen.mixEnd = mixEnd;
		putNoLock(gen);
