...
public class SoundPatchFactory {
	...
	public static SoundPatch getNewSoundPatch(String name) {
		...
		if (name.equals(DEFAULT)) {
			...
			r.convertor.setConvertorLayerProperty(InstrumentConvertors.PERCUSSION2, 0, "velocity", 80);
			r.convertor.setConvertorLayerProperty(InstrumentConvertors.PERCUSSION2, 0, "accentVelocity", 90);
