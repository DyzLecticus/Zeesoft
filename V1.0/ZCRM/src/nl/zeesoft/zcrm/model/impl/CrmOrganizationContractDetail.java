...
@PersistCollection(entity=false,module=ZCRMModel.MODULE_ZCRM,nameSingle="Organization contract detail",nameMulti="Organization contract details")
@CacheableCollection
...
@DescribeCollection(
description=
	"Organization contract details define a customer specific price for a specific service or product.\n" +
	"")
public class CrmOrganizationContractDetail extends CrmContractDetailObject {
	@Override
	@ConstrainPropertyMandatory
	@PersistReference(property="contract",label="Contract",className="nl.zeesoft.zcrm.model.impl.CrmOrganizationContract",entityLabel="Contract details")
	public DtIdRef getContract() {
		return super.getContract();
	}
	@Override
	@ConstrainPropertyMandatory
	@PersistReference(property="serviceProduct",label="Service product",className="nl.zeesoft.zcrm.model.impl.CrmServiceProduct",entityLabel="Organization contract details",entity=false)
