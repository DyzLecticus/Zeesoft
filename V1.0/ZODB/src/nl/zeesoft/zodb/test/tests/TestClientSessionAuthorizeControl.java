...
public class TestClientSessionAuthorizeControl {
	...
	public static void main(String[] args) {
		...
		s = sw.getSession();
		System.out.println("Started client control session: " + s.getSessionId() + ", in: " + ((new Date()).getTime() - start.getTime()) + " ms");
		...
		r = s.getNewAuthorizationRequest(ClConfig.getInstance().getUserName(),ClConfig.getInstance().getUserPassword());
		r.addSubscriber(sub);
		System.out.println("Adding authorization request to queue");
		s.getRequestQueue().addRequest(r, s);
		System.out.println("Added authorization request to queue");
		...
		if (s!=null) {
			...
			System.out.println("Stopped client control session: " + s.getSessionId() + ", in: " + ((new Date()).getTime() - start.getTime()) + " ms");
