package nl.zeesoft.zmmt.gui.image;
...
public class ImageIconLabel extends ImageObject {

	public ImageIconLabel(String text, int size) {
		initialize(text,size,null);
	}
	
	public ImageIconLabel(String text, int size, Color background) {
