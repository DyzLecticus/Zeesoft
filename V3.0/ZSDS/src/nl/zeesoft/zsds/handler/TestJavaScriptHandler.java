...
import nl.zeesoft.zsds.resource.TestJavaScript;

public class TestJavaScriptHandler extends HandlerObject {
	public TestJavaScriptHandler(AppConfiguration config) {
		super(config,"/test.js");
	}
	...
	protected ZStringBuilder buildResponse() {
		TestJavaScript js = new TestJavaScript();
