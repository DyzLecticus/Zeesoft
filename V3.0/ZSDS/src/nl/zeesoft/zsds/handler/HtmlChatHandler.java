...
import nl.zeesoft.zsds.resource.ChatHtml;

public class HtmlChatHandler extends HandlerObject {
	public HtmlChatHandler(AppConfiguration config) {
		super(config,"/chat.html");
	}
