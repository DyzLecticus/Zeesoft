...
import nl.zeesoft.zsds.resource.EnvironmentHtml;

public class HtmlEnvironmentHandler extends HandlerObject {
	public HtmlEnvironmentHandler(AppConfiguration config) {
		super(config,"/environment.html");
	}
	...
	protected ZStringBuilder buildResponse() {
		EnvironmentHtml html = new EnvironmentHtml();
