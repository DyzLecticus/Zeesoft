...
public class BaseJavaScript {
	public ZStringBuilder toStringBuilder() {
		...
		script.append("ZSDS.xhr.onReadyStateChange = function(xhr,successCallback,errorCallback) {\n");
		...
		script.append("        } else {\n");
		script.append("            ZSDS.xhr.defaultErrorCallback(xhr);\n");
		script.append("        }\n");
		script.append("    }\n");
		script.append("};\n");
		script.append("ZSDS.xhr.getJSON = function(url,successCallback,errorCallback) {\n");
		script.append("    var xhr = new XMLHttpRequest();\n");
		script.append("    xhr.onreadystatechange = function() {\n");
		script.append("        ZSDS.xhr.onReadyStateChange(this,successCallback,errorCallback);\n");
		script.append("    }\n");
