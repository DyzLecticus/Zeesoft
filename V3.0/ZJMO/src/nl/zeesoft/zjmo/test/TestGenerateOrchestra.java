...
public class TestGenerateOrchestra extends TestObject {
	public TestGenerateOrchestra(Tester tester) {
		super(tester);
	}

	public static void main(String[] args) {
		(new TestGenerateOrchestra(new Tester())).test(args);
	}
	...
	protected void describe() {
		...
		System.out.println(" * " + getTester().getLinkForClass(TestGenerateOrchestra.class));
	...
	protected void test(String[] args) {
		...
		params[0] = Orchestrator.GENERATE_ORCHESTRA;
