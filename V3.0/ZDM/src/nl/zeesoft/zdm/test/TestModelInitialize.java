...
public class TestModelInitialize extends TestObject {
	...
	protected void describe() {
		...
		System.out.println("structure.addPackage(\"test.package\");");
		System.out.println("structure.addClass(\"test.package\",\"TestClass\");");
		System.out.println("structure.addProperty(\"test.package\",\"TestClass\",\"testProperty\");");
