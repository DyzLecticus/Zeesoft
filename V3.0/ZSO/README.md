...
**Release downloads**  
Click [here](https://github.com/DyzLecticus/Zeesoft/raw/master/V3.0/ZSO/releases/zso-0.9.5.zip) to download the latest ZSO release (version 0.9.5).  
...
Total test duration: 43 ms (total sleep duration: 0 ms).  
