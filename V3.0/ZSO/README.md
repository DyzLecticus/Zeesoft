...
**Release downloads**  
Click [here](https://github.com/DyzLecticus/Zeesoft/raw/master/V3.0/ZSO/releases/zso-0.9.4.zip) to download the latest ZSO release (version 0.9.4).  
...
Total test duration: 37 ms (total sleep duration: 0 ms).  
