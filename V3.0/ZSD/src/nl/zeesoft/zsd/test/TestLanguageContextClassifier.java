...
public class TestLanguageContextClassifier extends TestLanguageMasterContextClassifier {
	...
	protected void test(String[] args) {
		...
		if (config==null) {
			...
			assertEqual(scEng.getKnownLinks().size(),246,"The total number of english links does not match expectation");
			assertEqual(scNld.getKnownLinks().size(),290,"The total number of dutch links does not match expectation");
