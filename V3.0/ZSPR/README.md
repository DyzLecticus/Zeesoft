...
**Release downloads**  
Click [here](https://github.com/DyzLecticus/Zeesoft/raw/master/V3.0/ZSPR/releases/zspr-0.9.9.zip) to download the latest ZSPR release (version 0.9.9).  
...
~~~~
Initializing pattern manager took 1752 ms
...
Total test duration: 3061 ms (total sleep duration: 0 ms).  
