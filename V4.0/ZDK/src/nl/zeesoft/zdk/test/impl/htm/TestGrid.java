...
import nl.zeesoft.zdk.htm.grid.Grid;
import nl.zeesoft.zdk.htm.grid.GridRequest;
...
public class TestGrid extends TestObject {
	...
	public static void main(String[] args) {
		(new TestGrid(new Tester())).test(args);
	}
	...
	protected void test(String[] args) {
		...
		GridRequest request = new GridRequest(3);
		
		grid.start();
		System.out.println("Started grid");
		
		grid.addRequest(request);
