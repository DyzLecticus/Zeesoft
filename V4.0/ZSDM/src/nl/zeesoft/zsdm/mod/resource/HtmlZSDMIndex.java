package nl.zeesoft.zsdm.mod.resource;
...
public class HtmlZSDMIndex extends HtmlResource {
	public HtmlZSDMIndex(Config config) {
		super(config);
	}
	@Override
	public ZStringBuilder toStringBuilder() {
		...
		String url = getConfiguration().getModuleUrl(ModZSDM.NAME);
		...
		html.append("<tbody>\n");
			...
			*/
			...
			if (getConfiguration().getModule(ModZSDM.NAME).selfTest) {
				html.append("<tr>\n");
				html.append("<td>");
