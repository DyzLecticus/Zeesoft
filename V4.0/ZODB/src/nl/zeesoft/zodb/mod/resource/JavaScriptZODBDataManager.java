...
public class JavaScriptZODBDataManager {
	public ZStringBuilder toStringBuilder() {
		...
		script.append("ZODB.dm.idSizeMap = {};\n");
		...
		script.append("        }\n");
		script.append("        ZODB.dm.idSizeMap[\"\" + listObject.results[num].id] = listObject.results[num].size;\n");
		...
		script.append("        html+=\"</td>\";\n");
		script.append("        html+='<td' + bg + ' align=\"right\">';\n");
		script.append("        html+=listObject.results[num].size;\n");
		script.append("        html+=\"</td>\";\n");
		script.append("        html+=\"</tr>\";\n");
		script.append("    }\n");
		script.append("    html+=\"</tbody>\";\n");
		...
		script.append("    var size = ZODB.dm.idSizeMap[\"\" + id];\n");
		script.append("    if (size <= 99999) {\n");
		script.append("        ZODB.dm.selectedId = id;\n");
		script.append("        ZODB.dm.selectById(id);\n");
		script.append("    } else {\n");
		script.append("        ZODB.dm.objectTooLarge();\n");
		script.append("    }\n");
		script.append("};\n");
		...
		script.append("    }\n");
		script.append("};\n");
		script.append("ZODB.dm.objectTooLarge = function() {\n");
		script.append("    ZODB.dm.clearObject();\n");
