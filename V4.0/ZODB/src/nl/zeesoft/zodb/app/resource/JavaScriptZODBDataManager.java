...
public class JavaScriptZODBDataManager {
	public ZStringBuilder toStringBuilder() {
		...
		script.append("    }\n");
		//script.append("    console.log(request);\n");
		...
		//script.append("    console.log(response);\n");
		...
		script.append("    elem = window.document.getElementById(\"list\");\n");
		script.append("    if (elem!=null) {\n");
		...
		script.append("            ZODB.dm.showObject(object.results[num].object);\n");
		script.append("            break;\n");
		script.append("        }\n");
		script.append("    } else {\n");
		script.append("        ZODB.dm.clearObject();\n");
		...
		script.append("    }\n");
		script.append("};\n");
		script.append("ZODB.dm.showObject = function(obj) {\n");
		script.append("    elem = window.document.getElementById(\"object\");\n");
		script.append("    if (elem!=null) {\n");
