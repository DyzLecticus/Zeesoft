...
public class JavaScriptZODBDataManager {
	public ZStringBuilder toStringBuilder() {
		...
		script.append("    }\n");
		script.append("};\n");
		script.append("ZODB.dm.add = function() {\n");
		...
		script.append("        elem = window.document.getElementById(\"saveName\");\n");
		script.append("        if (elem!=null) {\n");
		script.append("            request.name = elem.value;\n");
		script.append("        }\n");
		script.append("        elem = window.document.getElementById(\"object\");\n");
		script.append("        if (elem!=null) {\n");
		script.append("            var obj = JSON.parse(elem.value);\n");
		script.append("            request.object = obj;\n");
		script.append("            ZODB.xhr.postJSON(\"../ZODB" + JsonZODBRequestHandler.PATH + "\",request,ZODB.dm.saveCallback,ZODB.dm.saveCallback);\n");
		script.append("        }\n");
		script.append("    } else {\n");
		script.append("        alert(\"Invalid JSON\");\n");
		script.append("    }\n");
		script.append("};\n");
		script.append("ZODB.dm.saveCallback = function(xhr) {\n");
		script.append("    var response = xhr.responseText;\n");
		script.append("    var object = ZODB.xhr.parseResponseJSON(response);\n");
		script.append("    if (object.error) {\n");
		script.append("        alert(object.error);\n");
