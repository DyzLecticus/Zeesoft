...
~~~~
Initializing the Translator took: 2494 ms
...
Total test duration: 2673 ms (total sleep duration: 1900 ms).  

Memory usage per test;  
 * nl.zeesoft.zevt.test.TestTranslator: 1093 Kb / 1 Mb
 * nl.zeesoft.zevt.test.TestTranslatorRequestResponse: 1097 Kb / 1 Mb
